            ...
            <div className="card-wrapper">
                <div className="dashboard-card">
                    <div className="card-content">
                        ...
                        <div className="user-followers">1987</div>
                        <div className="followers-description">FOLLOWERS</div>
                        <div className="update-section">
                            <div className="update-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            </div>
                            <div className="followers-update">12 Today</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="dashboard-card">
                    <div className="card-content">
                        ...
                        <div className="user-followers">1044</div>
                        <div className="followers-description">FOLLOWERS</div>
                        <div className="update-section">
                            <div className="update-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            </div>
                            <div className="followers-update">99 Today</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="dashboard-card">
                    <div className="card-content">
                        <div className="user-profile">
                            ...
                            <div className="user-name">@realnathanf</div>
                        </div>

                        <div className="user-followers">11k</div>
                        <div className="followers-description">FOLLOWERS</div>
                        <div className="update-section">
                            <div className="update-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                            </div>
                            <div className="followers-update">1099 Today</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="last-dashboard">
                    <div className="card-content">
                        <div className="user-profile">
                            ...
                            <div className="user-name">Nathan. F</div>
                        </div>

                        <div className="user-followers">8239</div>
                        <div className="followers-description">SUBSCRIBERS</div>
                        <div className="update-section">
                            <div className="update-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg>
                            </div>
                            <div className="followers-update">
                                <h1 style={{color:'hsl(356, 69%, 56%)'}}>144 Today</h1>
                            </div>
                        </div>
                    </div>
                </div>
